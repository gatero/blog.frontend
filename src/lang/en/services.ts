const Services = Object.freeze({
  items: [
    ...
    },
    {
      title: 'Carnerio',
      description:
        "Working on Carnerio I learned to work with responsive technologies, firs we create simple grid systems for our sites, before we start to use technologies as bootstrap and foundation a side with jQuery in a lot of static sites for different companies and government institutions, when I arrive to Carnerio I've been working as freelancer",
